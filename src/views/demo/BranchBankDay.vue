  ...
  <div>
    ...
    <van-row type="flex" justify="center">
      <van-radio-group v-model="changeAmount" direction="horizontal">
        <van-radio name="300">300万</van-radio>
        <van-radio name="500">500万</van-radio>
        <van-radio name="1000">1000万</van-radio>
      </van-radio-group>
    </van-row>
        ...
        <van-cell v-for="(item, index) in list" :key="index">
          <template #title>
            <van-row>
              ...
              <van-col span="18">{{item.bank}}</van-col>
